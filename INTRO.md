...
*   **24 AI Experts:** A team of specialized local AI Agents dedicated to each financial domain.
...
| **Agent Directory** | Danh bạ chi tiết 24 Chuyên gia AI | [Xem tại đây](docs/agent_directory.md) |
...
| **Agent Directory** | 24 AI Experts Detailed Directory | [View here](docs/agent_directory_en.md) |
...
| **代理目录 (Agent Directory)** | 24位AI专家详细名录 | [在此查看](docs/agent_directory_zh.md) |
...
| **에이전트 디렉토리 (Agent Directory)** | 24인의 AI 전문가 상세 명단 | [여기서 보기](docs/agent_directory_ko.md) |
...
| **エージェントディレクトリ (Agent Dir.)** | 24人のAI専門家詳細名簿 | [ここを表示](docs/agent_directory_ja.md) |
